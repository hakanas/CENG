...
public class Expert extends ConManDecorator {
    ...
    public void draw(Graphics2D g2d) {
        ...
        g2d.fillRect((int) decoratedConMan.getPositionX() + 70 , 
                        (int) decoratedConMan.getPositionY() - 40, 20, 20);
    ...
    public void step(Common common) throws IOException {
        if (decoratedConMan.status != null && decoratedConMan.status.equals("Guru")) {
                this.decoratedConMan = new Guru(this.decoratedConMan);
            }

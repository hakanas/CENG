...
public class RMIClient extends JFrame
{
  ...
  public RMIClient ()
  {
    ...
    try {
        ...
        System.err.println("RMIClient exception: " + ex.toString());
    }
  ...
  {//GEN-HEADEREND:event_bSubmitActionPerformed
    ...
    ResultTableModel newModel = null;
        
    System.out.println("Submitted Sql process is -> " + taSQL.getText());
    
    try {
        newModel = new ResultTableModel(remoteDatabase.processSQL(taSQL.getText(), rbQuery.isSelected()));
  ...
  public static void main ( String args[] )
  {
    ...
    java.awt.EventQueue.invokeLater( new Runnable() { @Override public void run () { new RMIClient().setVisible( true ) ; } } ) ;
  }
